...
const Hero = (props: Props) => {
  ...
  return (
    <div className="relative h-auto max-w-[1280px] lg:pt-32 md:px-10 mx-auto pt-16">
      <img
      ...
      <div className="flex">
        ...
        <div className=" absolute pt-32 mt-28 max-md:px-4 ml-4 md:ml-12">
          ...
          <div className="flex lg:w-11/12 md:space-x-5 max-md:flex-col">
            <form action="">
              <div className="grid max-md:grid-rows-2 md:grid-cols-2 w-full">
                <dl>
                  <dd>
                    <input
          ...
          <div className="md:my-32 my-24 h-fit md:h-auto">
            <p className="text-[16px] leading-[24px] text-[#7d8590]">
              Trusted by the world&apos;s leading&nbsp;organizations&nbsp;↘︎
            </p>
            <div className="flex gap-3 md:gap-0 flex-col items-start md:flex-row flex-wrap justify-center md:justify-between md:items-center mt-10">
              <img
